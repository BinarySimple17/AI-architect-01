...
# ============================================
# 5. Redis (кэш результатов поиска, TTL 24 часа/4 часа)
# ============================================
...
| Redis | Кэш результатов поиска (TTL 24 часа/4 часа, инвалидация при обновлении БД) | 10Gi storage, 2Gi RAM (maxmemory 2gb) |
